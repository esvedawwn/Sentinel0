...
- [AI intelligence layer](ai-intelligence-layer.md) — classifyWithAI() in ai/index.ts; LocalRuleProvider always available offline; OpenAI/Embeddings are stubs; AI_PROVIDER env var overrides auto-selection.
